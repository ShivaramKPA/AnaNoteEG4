...
%It is assumed that the efficiency  %xz: Is it really an assumption or is true? It is the real theoretical prediction, right?
The efficiency for some specific kinematic bin depends on the average number of photoelectrons %(the corresponding variable in the data ntuple is ``nphe''), %SEKpr: Explain both trigger eff + nphe cut! 
