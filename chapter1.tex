...
However, a subsequent, more precise measurement over a % at a %GED
larger kinematic region performed by the EMC experiment at CERN reported, contrary to the NPM predictions, that only $12\pm 17\%$ %(i.e., practically none) 
of the spin is carried by the quarks \cite{Ashman1988364}. %, Piguet:1989va}. %sek
This discovery of the so-called ``spin crisis'' %has
...
Recently the JLab EG1b experiment has provided some finite \qsqs results for both deuteron %(see Fig. \ref{modelGm0})
as well as nucleon targets \cite{PhysRevC.92.055201}.%{nGuler_th}. 
\begin{comment}
