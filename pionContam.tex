...
One of the two major sources of backgrounds in the measured EG4 electron rates comes from misidentified negatively charged pions (\pim) that produce similar set of signals as electrons in various detector components and thus pass the electron ID cuts. In the EG4 experiment, signals from the electromagnetic calorimeter (EC) and Cherenkov counter (CC) are used to %discriminate %xz
identify %separate
...
\begin{figure}[H]
  \centering
\subfigure[For the $1^{st}$ p-bin and $7^{th}$ \th-bin.]{
  \includegraphics[scale=0.31]{TexmakerMyFinTh/FigBkGrnd/purePi_ContEl2999_0_6}
  %\leavevmode \includegraphics[width=0.31\textwidth]{TexmakerMyFinTh/FigBkGrnd/purePi_ContEl2999_0_6.png}  
\label{fignphe01}
}
\subfigure[For the $1^{st}$ p-bin and $8^{th}$ \th-bin.]{
\includegraphics[scale=0.31]{TexmakerMyFinTh/FigBkGrnd/purePi_ContEl2999_0_7}
%\leavevmode \includegraphics[width=0.31\textwidth]{TexmakerMyFinTh/FigBkGrnd/purePi_ContEl2999_0_7.png}
\label{fignphe02}
}
...
\begin{figure}[ht]
\centering
\subfigure[For the first bin in momentum and seventh bin in \thns.]{\includegraphics[scale=0.31]{TexmakerMyFinTh/FigBkGrnd/pi2elRatio2999_0_6.png}
\label{figpiCont306}   }
\quad
\subfigure[For the first bin in momentum and eighth bin in \thns.]{\includegraphics[scale=0.31]{TexmakerMyFinTh/FigBkGrnd/pi2elRatio2999_0_7.png}
\label{figpiCont307}  }
\subfigure[Fits in the $\theta(9.0,10.0)$ bin for 1.339 GeV data.]{\includegraphics[scale=0.31]{TexmakerMyFinTh/FigBkGrnd/GlbFitLinThEbBoth_E1ppt.png} 
\label{figpcFit1}    }
\quad
\subfigure[Fits in the $\theta(9.0,10.0)$ bin for 2.0 GeV data.]{\includegraphics[scale=0.31]{TexmakerMyFinTh/FigBkGrnd/GlbFitLinThEbBoth_E3ppt.png}
\label{figpcFit2}    }
...
\label{figpiContN} %Effect of Dc-smear
